...
interface Table_public_inspections {
  id: number;
  created_at: string | null;
  updated_at: string | null;
  name_of_inspector: string | null;
  passed: boolean;
...
interface Schema_public {
  ...
  inspections: Table_public_inspections;
...
interface Tables_relationships {
  "public.inspections": {
    parent: {
       inspections_productId_fkey: "public.products";
    };
    children: {
  ...
  "public.products": {
    parent: {
       products_userId_fkey: "public.users";
    };
    children: {
       inspections_productId_fkey: "public.inspections";
    };
  };
  "public.users": {
    parent: {
    ...
    children: {
       products_userId_fkey: "public.products";
    };
  };
}
//#endregion
